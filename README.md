...
app/
  ...
  services/     Planner, BudgetGuard, JobQueue, Executor, Reconciler, PlanService, промпты, вебхуки
...
tests/          228 тестов, ни одного сетевого вызова и ни одного списания
...
### Что покрыто тестами (228 шт., все офлайн)
